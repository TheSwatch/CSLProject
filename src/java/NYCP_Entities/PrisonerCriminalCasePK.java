...
public class PrisonerCriminalCasePK implements Serializable {
    ...
    public String toString() {
        return "PackageEntities.PrisonerCriminalCasePK[ prisonFileNumber=" + prisonFileNumber + ", criminalCaseNumber=" + criminalCaseNumber + ", jurisdictionName=" + jurisdictionName + " ]";
    }
