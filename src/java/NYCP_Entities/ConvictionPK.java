 ...
 */
@Embeddable
public class ConvictionPK implements Serializable {
    ...
    public ConvictionPK(String decisionTypeNumber, String prisonFileNumber, Date dateOfDecision) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ConvictionPK)) {
            return false;
        }
        ConvictionPK other = (ConvictionPK) object;
    ...
    public String toString() {
        return "PackageEntities.ConvictionPK[ decisionTypeNumber=" + decisionTypeNumber + ", prisonFileNumber=" + prisonFileNumber + ", dateOfDecision=" + dateOfDecision + " ]";
    }
